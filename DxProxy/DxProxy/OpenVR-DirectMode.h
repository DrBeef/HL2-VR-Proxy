...
*/
class OpenVRDirectMode : public StereoView
{
public:
	OpenVRDirectMode();
	...
	virtual void PrePresentEx(IDirect3DSurface9* pDirect3DSurface9, D3DProxyDeviceEx* pProxyDevice);
	virtual void PostPresentEx(IDirect3DSurface9* pDirect3DSurface9, D3DProxyDeviceEx* pProxyDevice);
