...
OpenVRDirectMode::OpenVRDirectMode() : 
	...
	count(0)
{
	SHOW_CALL("OpenVRDirectMode::OpenVRDirectMode()");
}

void OpenVRDirectMode::Init(IDirect3DDevice9Ex* pActualDevice)
{
	SHOW_CALL("OpenVRDirectMode::Init");
...
void OpenVRDirectMode::PrePresentEx(IDirect3DSurface9* pDirect3DSurface9, D3DProxyDeviceEx* pProxyDevice)
{
	if (!vr::VRCompositor())
	{
...
void OpenVRDirectMode::PostPresentEx(IDirect3DSurface9* pDirect3DSurface9, D3DProxyDeviceEx* pProxyDevice)
{
	...
	vr::Texture_t leftEyeTexture = { pSurface11Left, vr::API_DirectX, vr::ColorSpace_Auto};
	...
	vr::Texture_t rightEyeTexture = { pSurface11Right, vr::API_DirectX, vr::ColorSpace_Auto};
